...
Third-party users of Solvia sometimes need to know the real-world time a block
...
would allow a Solvia cluster to satisfy this need.
...
As of https://github.com/solvia-labs/solvia/pull/10630, validators submit a
