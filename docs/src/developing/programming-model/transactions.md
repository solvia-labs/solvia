...
submitted to the cluster. The Solvia runtime will execute a program to process
...
a [digital signature](#signature-format) of the given message. The Solvia
...
construct a
[`SystemInstruction::CreateAccount`](https://github.com/solvia-labs/solvia/blob/6606590b8132e56dab9e60b3f7d20ba7412a736c/sdk/program/src/system_instruction.rs#L63)
instruction:
...
are handled differently in that they are built directly into the Solvia runtime.
...
The [Solvia Program Library's Token
program](https://github.com/solvia-labs/solvia-program-library/tree/master/token)
...
[Pack](https://github.com/solvia-labs/solvia/blob/master/sdk/program/src/program_pack.rs)
