...
pub fn parse_command(
    ...
    let response = match matches.subcommand() {
        ...
        ("addgrant", Some(matches)) => parse_add_grant(matches, default_signer, wallet_manager),
        ("voteongrant", Some(matches)) => parse_vote_on_grant(matches, default_signer, wallet_manager),
        //
        ("", None) => {
